...
export function AutomationBuilder({ mode, automationId }: AutomationBuilderProps) {
    ...
    localize(
      {
        ...
        "Payment & Confirmation": { en: "Payment & Confirmation", fr: "Paiement et confirmation", de: "Zahlung und Bestätigung", es: "Pago y confirmacion", pt: "Pagamento e confirmacao" },
        "Update Customer": { en: "Update Customer", fr: "Mettre a jour le client", de: "Kunde aktualisieren", es: "Actualizar cliente", pt: "Atualizar cliente" },
    ...
    localize(
      {
        ...
        send_payment_confirmation: { en: "Send Payment Confirmation", fr: "Envoyer une confirmation de paiement", de: "Zahlungsbestätigung senden", es: "Enviar confirmacion de pago", pt: "Enviar confirmacao de pagamento" },
        send_failed_payment_message: { en: "Send Failed Payment Message", fr: "Envoyer un message d echec de paiement", de: "Nachricht bei fehlgeschlagener Zahlung senden", es: "Enviar mensaje de pago fallido", pt: "Enviar mensagem de falha de pagamento" },
        ...
        update_status: { en: "Update Status", fr: "Mettre a jour le statut", de: "Status aktualisieren", es: "Actualizar estado", pt: "Atualizar estado" },
        ...
        generate_auto_reply: { en: "Generate Auto Reply", fr: "Generer une réponse automatique", de: "Automatische Antwort erzeugen", es: "Generar respuesta automatica", pt: "Gerar resposta automatica" },
    ...
    localize(
      {
        ...
        customer_created: { en: "New Customer Created", fr: "Nouveau client cree", de: "Neuer Kunde erstellt", es: "Nuevo cliente creado", pt: "Novo cliente criado" },
    ...
    localize(
      {
        ...
        invoice_paid: { en: "When a customer completes payment", fr: "Lorsqu un client termine le paiement", de: "Wenn ein Kunde die Zahlung abschliesst", es: "Cuando un cliente completa el pago", pt: "Quando um cliente conclui o pagamento" },
        ...
        payment_failed: { en: "When a payment attempt does not complete", fr: "Lorsqu une tentative de paiement n aboutit pas", de: "Wenn ein Zahlungsversuch nicht abgeschlossen wird", es: "Cuando un intento de pago no se completa", pt: "Quando uma tentativa de pagamento não e concluida" },
    ...
    localize(
      {
        ...
        customer_created: { en: "a new customer is created", fr: "un nouveau client est cree", de: "ein neuer Kunde erstellt wird", es: "se crea un nuevo cliente", pt: "um novo cliente e criado" },
    ...
    localize(
      {
        ...
        days: { en: "days", fr: "jours", de: "Tage", es: "dias", pt: "dias" },
      }[unit]
    );
  ...
  useEffect(() => {
    ...
    if (!safeAutomationId) {
      setStatus(t("Invalid automation link.", "Lien d automatisation invalide.", "Ungültiger Link zur Automatisierung.", "Enlace de automatización no valido.", "Ligacao de automação invalida."));
      setIsHydratingEdit(false);
      return;
    }
        ...
        if (!res.ok) {
          setStatus(
            resolveFriendlyApiMessage(
              json,
              t("Unable to load automation. Please try again.", "Impossible de charger l automatisation. Reessayez.", "Automatisierung konnte nicht geladen werden. Bitte versuche es erneut.", "No se pudo cargar la automatización. Intentalo de nuevo.", "Não foi possivel carregar a automação. Tente novamente."),
