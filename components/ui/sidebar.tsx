...
export function Sidebar({ role }: Props) {
  ...
  const labelMap = {
    ...
    "Events Explorer": t("Events Explorer", "Explorateur d événements"),
    ...
    SupportSettings: t("Support & Settings", "Support et paramètres"),
    Overview: t("Overview", "Vue d ensemble"),
    Operations: t("Operations", "Operations"),
    SystemMonitoring: t("System Monitoring", "Surveillance système"),
