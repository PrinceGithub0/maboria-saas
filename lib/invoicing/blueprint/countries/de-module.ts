...
export const germanyComplianceModule = buildDefaultCountryModule("DE", {
  ...
  evidence: [
    {
      label: "Germany UStG Section 14 invoice content requirements",
      url: "https://www.gesetze-im-internet.de/ustg_1980/__14.html",
      reviewedAt: "2026-04-06",
    },
    {
      label: "Germany UStG Section 14a special cases incl. reverse-charge wording",
    ...
    {
      label: "Germany UStG Section 12 VAT rates (standard/reduced)",
