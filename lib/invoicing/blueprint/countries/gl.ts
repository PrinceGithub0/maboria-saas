...
export const greenlandComplianceModule = buildDefaultCountryModule("GL", {
  implementationType: "SPECIALIZED",
  ruleVersion: "2026-04-07",
  evidence: [
    {
      label: "EU Commission: Greenland outside EU VAT rules",
  ...
  extendValidation(issues) {
    issues.push(
      createCountryIssue(
        ...
        "GL_LOCAL_TAX_RULES",
        "Greenland is outside EU VAT rules; apply local invoicing requirements.",
        "WARNING",
        "GL"
      )
    );
