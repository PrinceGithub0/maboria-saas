...
const ADMIN_SERVER_MESSAGES: Array<{ match: RegExp; label: AdminLocalizedText }> = [
  {
    ...
    label: {
      ...
      pt: "Não foi possível carregar os dados de administração neste momento.",
    },
  },
  {
  ...
  },
  {
    ...
    label: {
      ...
      pt: "Não foi possível concluir a ação de administração.",
    },
  },
  {
    match: /retry/i,
    label: {
      ...
      pt: "A operacao não foi concluída. Tente novamente.",
    },
  },
];

const ADMIN_ACTION_LABELS: Record<string, AdminLocalizedText> = {
  SUBSCRIPTION_UPDATED: adminText("Subscription updated", "Abonnement mis à jour", "Abonnement aktualisiert", "Suscripción actualizada", "Subscrição atualizada"),
  ...
  SUBSCRIPTION_DOWNGRADE_SCHEDULED: adminText("Subscription downgrade scheduled", "Retrogradation d'abonnement planifiee", "Abo-Herabstufung geplant", "Reduccion de suscripción programada", "Downgrade da subscrição agendado"),
  SUBSCRIPTION_DOWNGRADE_CANCELED: adminText("Subscription downgrade canceled", "Retrogradation d'abonnement annulee", "Abo-Herabstufung abgebrochen", "Reduccion de suscripción cancelada", "Downgrade da subscrição cancelado"),
  SUBSCRIPTION_DOWNGRADE_APPLIED: adminText("Subscription downgrade applied", "Retrogradation d'abonnement appliquee", "Abo-Herabstufung angewendet", "Reduccion de suscripción aplicada", "Downgrade da subscrição aplicado"),
  SUBSCRIPTION_PENDING_DOWNGRADES_APPLIED: adminText("Pending downgrades job ran", "Le traitement des retrogradations en attente a été execute", "Job für ausstehende Herabstufungen lief", "Se ejecuto el proceso de reducciones pendientes", "A tarefa de downgrades pendentes foi executada"),
  SUBSCRIPTION_DOWNGRADE_SKIPPED_PROVIDER_MANAGED: adminText("Provider-managed downgrade skipped", "Retrogradation geree par le fournisseur ignoree", "Anbieterverwaltete Herabstufung übersprungen", "Se omitio la reduccion gestionada por el proveedor", "O downgrade gerido pelo fornecedor foi ignorado"),
  SUBSCRIPTION_CANCELED: adminText("Subscription canceled", "Abonnement annule", "Abonnement gekuendigt", "Suscripción cancelada", "Subscrição cancelada"),
  SUBSCRIPTION_CANCEL_SCHEDULED: adminText("Subscription cancel scheduled", "Annulation d'abonnement planifiee", "Abo-Kuendigung geplant", "Cancelación de suscripción programada", "Cancelamento da subscrição agendado"),
  SUBSCRIPTION_RENEWAL_RESUMED: adminText("Subscription renewal resumed", "Renouvellement d'abonnement repris", "Abo-Verlaengerung fortgesetzt", "Se reanudo la renovacion de suscripción", "A renovacao da subscrição foi retomada"),
  SUBSCRIPTION_RENEWAL_ATTEMPTED: adminText("Subscription renewal attempted", "Tentative de renouvellement d'abonnement", "Abo-Verlaengerung versucht", "Intento de renovacion de suscripción", "Tentativa de renovacao da subscrição"),
  SUBSCRIPTION_RENEWALS_PROCESSED: adminText("Subscription renewals processed", "Renouvellements d'abonnement traites", "Abo-Verlaengerungen verarbeitet", "Renovaciones de suscripción procesadas", "Renovacoes da subscrição processadas"),
  SUBSCRIPTION_PAST_DUE: adminText("Subscription past due", "Abonnement en retard de paiement", "Abonnement überfaellig", "Suscripción vencida", "Subscrição em atraso"),
  SUBSCRIPTION_REVOKED: adminText("Subscription revoked", "Abonnement revoque", "Abonnement widerrufen", "Suscripción revocada", "Subscrição revogada"),
  SUBSCRIPTION_BACKFILLED_FROM_ORG: adminText("Subscription backfilled from organization", "Abonnement recopie depuis l'organisation", "Abonnement aus der Organisation übernommen", "Suscripción completada desde la organización", "Subscrição preenchida a partir da organização"),
  ADMIN_SUBSCRIPTION_CANCELED: adminText("Admin canceled subscription", "L administrateur a annule l abonnement", "Admin hat das Abonnement gekuendigt", "El administrador cancelo la suscripción", "O administrador cancelou a subscrição"),
  IDENTITY_SUBSCRIPTION_CANCELED: adminText("Identity subscription canceled", "Abonnement d identite annule", "Identitaetsabonnement gekuendigt", "Suscripción de identidad cancelada", "Subscrição de identidade cancelada"),
  USER_SIGNIN: adminText("User sign-in", "Connexion utilisateur", "Benutzeranmeldung", "Inicio de sesión del usuario", "Inicio de sessão do utilizador"),
  USER_SIGNOUT: adminText("User sign-out", "Deconnexion utilisateur", "Benutzerabmeldung", "Cierre de sesión del usuario", "Fim de sessão do utilizador"),
  INVITE_CREATED: adminText("Team invite created", "Invitation d équipe creee", "Team-Einladung erstellt", "Invitacion de equipo creada", "Convite de equipa criado"),
  INVITE_ACCEPTED: adminText("Team invite accepted", "Invitation d équipe acceptee", "Team-Einladung angenommen", "Invitacion de equipo aceptada", "Convite de equipa aceite"),
  INVITE_CANCELED: adminText("Team invite canceled", "Invitation d équipe annulee", "Team-Einladung storniert", "Invitacion de equipo cancelada", "Convite de equipa cancelado"),
  TEAM_INVITE_ACCEPT_FAILED: adminText("Team invite accept failed", "Échec de l acceptation de l'invitation d équipe", "Annahme der Team-Einladung fehlgeschlagen", "Fallo al aceptar la invitación de equipo", "Falha ao aceitar o convite de equipa"),
  ...
  MEMBER_PROMOTED_TO_BILLING_ADMIN: adminText("Member promoted to billing admin", "Membre promu administrateur de facturation", "Mitglied zum Abrechnungsadmin befoerdert", "Miembro ascendido a administrador de facturación", "Membro promovido a administrador de faturação"),
  BILLING_ADMIN_CHANGED: adminText("Billing admin changed", "Administrateur de facturation modifie", "Abrechnungsadmin geändert", "Administrador de facturación cambiado", "Administrador de faturação alterado"),
  MEMBER_ROLE_CHANGED: adminText("Member role changed", "Role du membre modifie", "Mitgliederrolle geändert", "Rol del miembro cambiado", "Papel do membro alterado"),
  TENANT_SUSPENDED: adminText("Tenant suspended", "Locataire suspendu", "Mandant gesperrt", "Tenant suspendido", "Tenant suspenso"),
  TENANT_REACTIVATED: adminText("Tenant reactivated", "Locataire réactivé", "Mandant reaktiviert", "Tenant reactivado", "Tenant reativado"),
  "TENANT.SUSPENDED": adminText("Tenant suspended", "Locataire suspendu", "Mandant gesperrt", "Tenant suspendido", "Tenant suspenso"),
  "TENANT.REACTIVATED": adminText("Tenant reactivated", "Locataire réactivé", "Mandant reaktiviert", "Tenant reactivado", "Tenant reativado"),
  BUSINESS_SETTINGS_UPDATED: adminText("Business settings updated", "Paramêtres entreprise mis à jour", "Unternehmenseinstellungen aktualisiert", "Configuración empresarial actualizada", "Definições empresariais atualizadas"),
  PAYOUT_SETTINGS_UPDATED: adminText("Payout settings changed", "Paramêtres de versement modifies", "Auszahlungseinstellungen geändert", "Configuración de pagos cambiada", "Definições de pagamento alteradas"),
  PASSWORD_SETUP_SENT: adminText("Password setup sent", "Configuration du mot de passe envoyée", "Passwort-Einrichtung gesendet", "Configuración de contrasena enviada", "Configuração de palavra-passe enviada"),
  TEMP_PASSWORD_GENERATED: adminText("Temporary password generated", "Mot de passe temporaire genere", "Temporäres Passwort generiert", "Contrasena temporal generada", "Palavra-passe temporaria gerada"),
  PRELAUNCH_EMAIL_SENT: adminText("Prelaunch email sent", "Email prelaunch envoyé", "Prelaunch-E-Mail gesendet", "Correo de prelaunch enviado", "Email de prelaunch enviado"),
  PRELAUNCH_EMAIL_FAILED: adminText("Prelaunch email failed", "Échec de l'e-mail prelaunch", "Prelaunch-E-Mail fehlgeschlagen", "Fallo del correo de prelaunch", "Falha no email de prelaunch"),
  PRELAUNCH_CHECKS_RUN: adminText("Prelaunch checks run", "Vérifications prelaunch exécutées", "Prelaunch-Prüfungen ausgeführt", "Comprobaciones de prelaunch ejecutadas", "Verificações de prelaunch executadas"),
  PRELAUNCH_LOG_CHECK: adminText("Prelaunch log check", "Vérification du journal prelaunch", "Prelaunch-Protokollprüfung", "Comprobación de registro de prelaunch", "Verificação de registo de prelaunch"),
  WEBHOOK_PROCESSED: adminText("Webhook processed", "Webhook traite", "Webhook verarbeitet", "Webhook procesado", "Webhook processado"),
  WEBHOOK_FAILED: adminText("Webhook failed", "Webhook échoué", "Webhook fehlgeschlagen", "Webhook fallido", "Webhook falhou"),
  ...
  SUPPORT_SUBSCRIBER_REPLY_RECEIVED: adminText("Support subscriber reply received", "Réponse du client de support recue", "Antwort des Support-Kunden empfangen", "Respuesta del cliente de soporte recibida", "Resposta do cliente de suporte recebida"),
  AI_REQUEST: adminText("AI request", "Requête IA", "KI-Anfrage", "Solicitud de IA", "Pedido de IA"),
  AI_TOKENS: adminText("AI tokens", "Jetons IA", "KI-Token", "Tokens de IA", "Tokens de IA"),
  AUTOMATION_RUN_FAILED: adminText("Automation run failed", "Exécution d'automatisation échouée", "Automatisierungsausführung fehlgeschlagen", "La ejecución de automatización falló", "A execução da automação falhou"),
  AUTOMATION_RUN_SUCCESS: adminText("Automation run succeeded", "Exécution d'automatisation réussie", "Automatisierungsausführung erfolgreich", "La ejecución de automatización tuvo éxito", "A execução da automação teve sucesso"),
  AUTOMATION_RUN_SUCCEEDED: adminText("Automation run succeeded", "Exécution d'automatisation réussie", "Automatisierungsausführung erfolgreich", "La ejecución de automatización tuvo éxito", "A execução da automação teve sucesso"),
  AUTOMATION_RUN_PENDING: adminText("Automation run pending", "Exécution d'automatisation en attente", "Automatisierungsausführung ausstehend", "Ejecución de automatización pendiente", "Execução da automação pendente"),
  AUTOMATION_RETRY_ATTEMPT: adminText("Automation retry attempt", "Nouvelle tentative d'automatisation", "Automatisierungs-Neuversuch", "Reintento de automatización", "Nova tentativa de automação"),
  AUTOMATION_FAILURE_RECORDED: adminText("Automation failure recorded", "Échec d'automatisation enregistré", "Automatisierungsfehler erfasst", "Fallo de automatización registrado", "Falha de automação registada"),
  AUTOMATION_RECOVERY_RETRYING: adminText("Automation recovery retrying", "Récupération d'automatisation en nouvelle tentative", "Automatisierungswiederherstellung versucht erneut", "La recuperación de automatización está reintentando", "A recuperação da automação está a tentar novamente"),
  AUTOMATION_RECOVERED: adminText("Automation recovered", "Automatisation récupérée", "Automatisierung wiederhergestellt", "Automatización recuperada", "Automação recuperada"),
  AUTOMATION_HEALTH_ALERT: adminText("Automation health alert", "Alerte de santé d'automatisation", "Automatisierungswarnung", "Alerta de salud de automatización", "Alerta de saúde da automação"),
};

const ADMIN_LOG_MESSAGE_LABELS: Record<string, AdminLocalizedText> = {
  "system flag updated": adminText("System flag updated", "Indicateur système mis à jour", "System-Flag aktualisiert", "Indicador del sistema actualizado", "Indicador do sistema atualizado"),
  "subscription upgraded": adminText("Subscription upgraded", "Abonnement ameliore", "Abonnement hochgestuft", "Suscripción mejorada", "Subscrição melhorada"),
  "subscription downgraded": adminText("Subscription downgraded", "Abonnement retrograde", "Abonnement herabgestuft", "Suscripción degradada", "Subscrição reduzida"),
  "subscription upgraded plan": adminText("Subscription plan upgraded", "Forfait d'abonnement mis a niveau", "Abo-Plan hochgestuft", "Plan de suscripción mejorado", "Plano de subscrição atualizado"),
  "subscription payment failed": adminText("Subscription payment failed", "Le paiement de l'abonnement a échoué", "Abo-Zahlung fehlgeschlagen", "El pago de la suscripción fallo", "O pagamento da subscrição falhou"),
  "user login succeeded": adminText("User login succeeded", "Connexion utilisateur reussie", "Benutzeranmeldung erfolgreich", "Inicio de sesión del usuario correcto", "Inicio de sessão do utilizador com sucesso"),
  "user login failed": adminText("User login failed", "Échec de connexion utilisateur", "Benutzeranmeldung fehlgeschlagen", "Fallo el inicio de sesión del usuario", "Falha no inicio de sessão do utilizador"),
  "invite created": adminText("Invite created", "Invitation creee", "Einladung erstellt", "Invitacion creada", "Convite criado"),
  "team invite created": adminText("Team invite created", "Invitation d équipe creee", "Team-Einladung erstellt", "Invitacion de equipo creada", "Convite de equipa criado"),
  "invite accepted": adminText("Invite accepted", "Invitation acceptee", "Einladung angenommen", "Invitacion aceptada", "Convite aceite"),
  "team invite accepted": adminText("Team invite accepted", "Invitation d équipe acceptee", "Team-Einladung angenommen", "Invitacion de equipo aceptada", "Convite de equipa aceite"),
  "invite canceled": adminText("Invite canceled", "Invitation annulee", "Einladung storniert", "Invitacion cancelada", "Convite cancelado"),
  "team invite canceled": adminText("Team invite canceled", "Invitation d équipe annulee", "Team-Einladung storniert", "Invitacion de equipo cancelada", "Convite de equipa cancelado"),
  "team invite accept failed": adminText("Team invite accept failed", "Échec de l acceptation de l'invitation d équipe", "Annahme der Team-Einladung fehlgeschlagen", "Fallo al aceptar la invitación de equipo", "Falha ao aceitar o convite de equipa"),
  ...
  "inbox message sent": adminText("Inbox message sent", "Message de boite de reception envoyé", "Posteingangsnachricht gesendet", "Mensaje de bandeja de entrada enviado", "Mensagem da caixa de entrada enviada"),
  "paystack payment failed": adminText("Paystack payment failed", "Le paiement Paystack a échoué", "Paystack-Zahlung fehlgeschlagen", "El pago de Paystack fallo", "O pagamento Paystack falhou"),
  "flutterwave payment failed": adminText("Flutterwave payment failed", "Le paiement Flutterwave a échoué", "Flutterwave-Zahlung fehlgeschlagen", "El pago de Flutterwave fallo", "O pagamento Flutterwave falhou"),
};
...
export function localizeAdminSource(value: string | null | undefined, language: Language) {
  ...
  const map: Record<string, AdminLocalizedText> = {
    ...
    BILLING: adminText("Billing", "Facturation", "Abrechnung", "Facturación", "Faturação"),
    AUTOMATION: adminText("Automation", "Automatisation", "Automatisierung", "Automatización", "Automação"),
    ...
    SECURITY: adminText("Security", "Sécurité", "Sicherheit", "Seguridad", "Seguranca"),
    ...
    SYSTEM_FLAG: adminText("System flag audits", "Audits des drapeaux système", "System-Flag-Audits", "Auditorias de indicadores del sistema", "Auditorias de indicadores do sistema"),
  };
  return getLocalizedText(
    map[normalized] || adminText(normalized || "-", normalized || "-", normalized || "-", normalized || "-", normalized || "-"),
    language
...
export function localizeAdminLogMessage(
  ...
  if (repeatedFailures) {
    ...
    return getLocalizedText(
      adminText(`Repeated ${stepType} failures detected for automation ${flowTitle}. Check provider health.`, `Échecs répétés de ${stepType} détectés pour l'automatisation ${flowTitle}. Vérifiez le fournisseur.`, `Wiederholte ${stepType}-Fehler für die Automatisierung ${flowTitle} erkannt. Anbieterzustand prüfen.`, `Se detectaron fallos repetidos de ${stepType} en la automatización ${flowTitle}. Revisa el proveedor.`, `Foram detetadas falhas repetidas de ${stepType} na automação ${flowTitle}. Verifique o fornecedor.`),
      language
    );
  }
