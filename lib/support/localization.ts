...
export const SUPPORT_CATEGORY_OPTIONS: Array<{
  ...
  },
  {
    ...
    label: { en: "Account & Security", fr: "Compte et sécurité", de: "Konto und Sicherheit", es: "Cuenta y seguridad", pt: "Conta e segurança" },
...
const SUPPORT_SERVER_MESSAGES: Record<string, LocalizedText> = {
  ...
  "Attachment is invalid or exceeds 5MB.": {
    ...
    de: "Der Anhang ist ungültig oder großer als 5 MB.",
  ...
  "Failed to submit ticket": {
    ...
    pt: "Não foi possível submeter o ticket.",
  },
  "Not found": { en: "Not found.", fr: "Introuvable.", de: "Nicht gefunden.", es: "No encontrado.", pt: "Não éncontrado." },
  "Subscribers can only reopen tickets.": {
    en: "Subscribers can only reopen tickets.",
    fr: "Les abonnés peuvent uniquement rouvrir des tickets.",
