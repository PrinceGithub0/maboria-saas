...
const FLAG_DEFS: Array<{
  ...
  { key: "maintenance_mode", section: "Platform", label: text("Maintenance Mode", "Mode maintenance", "Wartungsmodus", "Modo mantenimiento", "Modo de manutencao"), description: text("Block non-admin traffic platform-wide.", "Bloquer le trafic non admin sur toute la plateforme.", "Nicht-Admin-Datenverkehr plattformweit blockieren.", "Bloquear el tráfico no administrativo en toda la plataforma.", "Bloquear trafego não administrativo em toda a plataforma.") },
  ...
  { key: "payments_enabled", section: "Billing", label: text("Payments", "Paiements", "Zahlungen", "Pagos", "Pagamentos"), description: text("Enable checkout and subscription write flows.", "Activer les flux de paiement et d'ecriture d'abonnement.", "Checkout- und Schreibabläufe für Abonnements aktivieren.", "Activar los flujos de pago y escritura de suscripciones.", "Ativar fluxos de checkout e escrita de subscricoes.") },
  { key: "automation_enabled", section: "Automation", label: text("Automation Engine", "Moteur d'automatisation", "Automatisierungs-Engine", "Motor de automatización", "Motor de automação"), description: text("Allow automation processing and execution.", "Autoriser le traitement et l'ex?cution de l'automatisation.", "Verarbeitung und Ausführung von Automatisierungen zulassen.", "Permitir el procesamiento y la ejecución de automatizaciones.", "Permitir o processamento e a execução de automatizacoes.") },
  { key: "automation_replay_enabled", section: "Automation", label: text("Automation Replay", "Relecture d'automatisation", "Automatisierungs-Wiederholung", "Repeticion de automatización", "Repeticao de automação"), description: text("Allow replay endpoints for failed runs.", "Autoriser les points de terminaison de relecture pour les executions échouées.", "Replay-Endpunkte für fehlgeschlagene Ausführungen zulassen.", "Permitir endpoints de repeticion para ejecuciones fallidas.", "Permitir endpoints de repeticao para execucoes falhadas.") },
  ...
  { key: "impersonation_enabled", section: "Admin Tools", label: text("Impersonation", "Usurpation", "Identitätswechsel", "Suplantacion", "Representacao"), description: text("Allow admin impersonation start endpoint.", "Autoriser le point de terminaison de demarrage de l'usurpation admin.", "Start-Endpunkt für Admin-Identitätswechsel zulassen.", "Permitir el endpoint de inicio de suplantacion administrativa.", "Permitir o endpoint de inicio de representação administrativa.") },
  { key: "admin_notifications_enabled", section: "Admin Tools", label: text("Admin Notifications", "Notifications admin", "Admin-Benachrichtigungen", "Notificaciónes admin", "Notificações admin"), description: text("Enable admin notifications ingestion/listing.", "Activer l'ingestion et la liste des notifications admin.", "Erfassung und Auflistung von Admin-Benachrichtigungen aktivieren.", "Activar la ingestion y el listado de notificaciones admin.", "Ativar ingestao e listagem de notificações admin.") },
  { key: "system_logs_enabled", section: "Admin Tools", label: text("System Logs", "Journaux système", "Systemprotokolle", "Registros del sistema", "Registos do sistema"), description: text("Enable system logs export APIs.", "Activer les API d'export des journaux système.", "Export-APIs für Systemprotokolle aktivieren.", "Activar las API de exportacion de registros del sistema.", "Ativar APIs de exportacao de registos do sistema.") },
...
const DANGEROUS_CONFIRM: Record<SystemFlag, { title: CompleteLocalizedText; body: CompleteLocalizedText }> = {
  maintenance_mode: {
    ...
    body: text("This blocks all non-admin traffic until disabled. Confirm to continue.", "Cela bloque tout le trafic non admin jusqu'a desactivation. Confirmez pour continuer.", "Dies blockiert den gesamten Nicht-Admin-Datenverkehr bis zur Deaktivierung. Bestatige, um fortzufahren.", "Esto bloquea todo el tráfico no administrativo hasta desactivarlo. Confirma para continuar.", "Isto bloqueia todo o trafego não administrativo at? ser desativado. Confirme para continuar."),
  },
  payments_enabled: {
    title: text("Change Payments Flag?", "Modifier le drapeau des paiements ?", "Zahlungs-Flag ändern?", "Cambiar el indicador de pagos?", "Alterar o indicador de pagamentos?"),
    body: text("Disabling payments stops checkout and subscription creation flows platform-wide.", "Désactiver les paiements arrête les flux de paiement et de création d'abonnement sur toute la plateforme.", "Das Deaktivieren von Zahlungen stoppt Checkout- und Abo-Erstellungsabläufe plattformweit.", "Desactivar los pagos detiene los flujos de checkout y creación de suscripciones en toda la plataforma.", "Desativar pagamentos interrompe os fluxos de checkout e criação de subscrições em toda a plataforma."),
  },
  impersonation_enabled: {
    title: text("Change Impersonation Flag?", "Modifier le drapeau d'usurpation ?", "Identitätswechsel-Flag ändern?", "Cambiar el indicador de suplantacion?", "Alterar o indicador de representação?"),
    body: text("Disabling impersonation blocks support impersonation starts immediately.", "Désactiver l'usurpation bloque immédiatement le démarrage des usurpations de support.", "Das Deaktivieren des Identitätswechsels blockiert sofort den Start von Support-Identitätswechseln.", "Desactivar la suplantación bloquea de inmediato el inicio de suplantaciones de soporte.", "Desativar a representação bloqueia imediatamente o início de representações de suporte."),
  },
  automation_replay_enabled: {
    title: text("Change Automation Replay Flag?", "Modifier le drapeau de relecture d'automatisation ?", "Automatisierungs-Replay-Flag ändern?", "Cambiar el indicador de repetición de automatización?", "Alterar o indicador de repetição de automação?"),
    body: text("Disabling replay blocks automation recovery replay endpoints.", "Désactiver la relecture bloque les points de terminaison de reprise d'automatisation.", "Das Deaktivieren des Replays blockiert Replay-Endpunkte für die Automatisierungswiederherstellung.", "Desactivar la repetición bloquea los endpoints de recuperación de automatizaciones.", "Desativar a repetição bloqueia os endpoints de recuperação da automação."),
  },
  allow_signup: { title: text("Change Signup Flag?", "Modifier le drapeau d'inscription ?", "Registrierungs-Flag ändern?", "Cambiar el indicador de registro?", "Alterar o indicador de registo?"), body: text("This changes account registration availability.", "Cela modifie la disponibilité des inscriptions de compte.", "Dies ändert die Verfügbarkeit der Kontoregistrierung.", "Esto cambia la disponibilidad del registro de cuentas.", "Isto altera a disponibilidade do registo de contas.") },
  automation_enabled: { title: text("Change Automation Engine Flag?", "Modifier le drapeau du moteur d'automatisation ?", "Automatisierungs-Engine-Flag ändern?", "Cambiar el indicador del motor de automatización?", "Alterar o indicador do motor de automação?"), body: text("This changes automation execution and scheduler behavior.", "Cela modifie l'exécution de l'automatisation et le comportement du planificateur.", "Dies ändert die Automatisierungsausführung und das Verhalten des Planers.", "Esto cambia la ejecución de automatizaciones y el comportamiento del programador.", "Isto altera a execução da automação e o comportamento do agendador.") },
  ai_enabled: { title: text("Change AI Flag?", "Modifier le drapeau IA ?", "KI-Flag ändern?", "Cambiar el indicador de IA?", "Alterar o indicador de IA?"), body: text("This changes AI assistant API availability.", "Cela modifie la disponibilité des API de l'assistant IA.", "Dies ändert die Verfügbarkeit der APIs des KI-Assistenten.", "Esto cambia la disponibilidad de las API del asistente de IA.", "Isto altera a disponibilidade das APIs do assistente de IA.") },
  support_enabled: { title: text("Change Support Flag?", "Modifier le drapeau support ?", "Support-Flag ändern?", "Cambiar el indicador de soporte?", "Alterar o indicador de suporte?"), body: text("This changes support ticket create/reply availability.", "Cela modifie la disponibilité de création et de réponse des tickets de support.", "Dies ändert die Verfügbarkeit zum Erstellen und Beantworten von Support-Tickets.", "Esto cambia la disponibilidad de creación y respuesta de tickets de soporte.", "Isto altera a disponibilidade de criação e resposta de tickets de suporte.") },
  admin_notifications_enabled: { title: text("Change Admin Notifications Flag?", "Modifier le drapeau des notifications admin ?", "Admin-Benachrichtigungs-Flag ändern?", "Cambiar el indicador de notificaciones admin?", "Alterar o indicador de notificações admin?"), body: text("This changes admin notifications listing and ingestion.", "Cela modifie la liste et l'ingestion des notifications admin.", "Dies ändert die Auflistung und Erfassung von Admin-Benachrichtigungen.", "Esto cambia el listado y la ingestión de notificaciones admin.", "Isto altera a listagem e ingestão de notificações admin.") },
  system_logs_enabled: { title: text("Change System Logs Flag?", "Modifier le drapeau des journaux système ?", "Systemprotokoll-Flag ändern?", "Cambiar el indicador de registros del sistema?", "Alterar o indicador de registos do sistema?"), body: text("This changes logs export endpoint availability.", "Cela modifie la disponibilité des points de terminaison d'export des journaux.", "Dies ändert die Verfügbarkeit der Export-Endpunkte für Protokolle.", "Esto cambia la disponibilidad de los endpoints de exportación de registros.", "Isto altera a disponibilidade dos endpoints de exportação de registos.") },
  webhooks_ingest_enabled: { title: text("Change Webhooks Flag?", "Modifier le drapeau des webhooks ?", "Webhook-Flag ändern?", "Cambiar el indicador de webhooks?", "Alterar o indicador de webhooks?"), body: text("This changes non-critical webhook ingest endpoints.", "Cela modifie les points de terminaison d'ingestion de webhooks non critiques.", "Dies ändert nicht-kritische Webhook-Erfassungsendpunkte.", "Esto cambia los endpoints de ingestión de webhooks no críticos.", "Isto altera os endpoints de ingestão de webhooks não críticos.") },
  exports_enabled: { title: text("Change Exports Flag?", "Modifier le drapeau des exports ?", "Export-Flag ändern?", "Cambiar el indicador de exportaciones?", "Alterar o indicador de exportações?"), body: text("This changes CSV/JSON export endpoint availability.", "Cela modifie la disponibilité des points de terminaison d'export CSV/JSON.", "Dies ändert die Verfügbarkeit der CSV/JSON-Export-Endpunkte.", "Esto cambia la disponibilidad de los endpoints de exportación CSV/JSON.", "Isto altera a disponibilidade dos endpoints de exportação CSV/JSON.") },
};
...
export default function SystemFlagsPage() {
        ...
        throw new Error(
          String(
            (payload as { error?: string }).error ||
              t("Unable to update flag.", "Impossible de mettre à jour le drapeau.", "Flag kann nicht aktualisiert werden.", "No se puede actualizar el indicador.", "Não foi possível atualizar o indicador.")
          )
        );
      }
      setActionStatus({
  ...
  const refreshCache = async () => {
    ...
    try {
      ...
      if (!res.ok) {
        throw new Error(
          t(
            ...
            "Impossible de rafraîchir le cache des drapeaux.",
      ...
      await mutate();
      setActionStatus({
        message: t("Flags cache refreshed.", "Cache des drapeaux rafraîchi.", "Flag-Cache aktualisiert.", "Cache de indicadores actualizada.", "Cache de indicadores atualizada."),
        variant: "success",
      });
    } catch (error) {
      setActionStatus({
  ...
  return (
    <div className="space-y-4 px-6 py-6 max-md:px-4 max-md:py-4">
      <div>
        ...
        <h1 className="text-3xl font-semibold text-foreground">{t("System flags", "Drapeaux système", "System-Flags", "Indicadores del sistema", "Indicadores do sistema")}</h1>
      ...
      <Card title={t("Control plane", "Plan de controle", "Kontrollebene", "Plano de control", "Plano de controlo")}>
        <div className="mb-4 flex flex-wrap items-center justify-between gap-2">
          <p className="text-xs text-muted-foreground">{t("Only SUPER_ADMIN can toggle system flags.", "Seul SUPER_ADMIN peut activer ou désactiver les drapeaux système.", "Nur SUPER_ADMIN kann System-Flags umschalten.", "Solo SUPER_ADMIN puede cambiar los indicadores del sistema.", "Apenas SUPER_ADMIN pode alternar os indicadores do sistema.")}</p>
                    ...
                    <div key={item.key} className="flex items-center justify-between gap-3 rounded-xl border border-border/70 bg-muted/25 px-4 py-3">
                      <div className="min-w-0">
                        ...
                        <p className="mt-1 text-[11px] text-muted-foreground">
                          {t("Last modified:", "Derni?re modification :", "Zuletzt geändert:", "Última modificacion:", "Última alteração:")}{" "}
      ...
      <Modal open={historyOpen} onClose={() => setHistoryOpen(false)} title={t("System Flag History", "Historique des drapeaux système", "System-Flag-Verlauf", "Historial de indicadores del sistema", "Histórico dos indicadores do sistema")}>
        {historyLoading ? (
          <div className="space-y-2">
            {Array.from({ length: 6 }).map((_, index) => (
          ...
          <div className="space-y-2">
            {historyData?.history?.length ? (
              ...
              <p className="text-sm text-muted-foreground">{t("No flag history found.", "Aucun historique de drapeau trouvé.", "Kein Flag-Verlauf gefunden.", "No se encontró historial de indicadores.", "Nenhum histórico de indicadores encontrado.")}</p>
            )}
          </div>
        )}
      </Modal>
