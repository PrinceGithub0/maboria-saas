        ...
        <div className="relative rounded-2xl border border-slate-200 bg-white p-6 shadow-[0_14px_40px_-28px_rgba(15,23,42,0.28)] sm:p-8">
          {impersonation ? (
            ...
            {actorCanManageSubscription
              ...
              : t("Workspace Locked", "Espace de travail verrouille", "Workspace gesperrt", "Espacio de trabajo bloqueado", "Espaco de trabalho bloqueado")}
          </div>
          ...
          <h1 className="mt-3 text-3xl font-bold tracking-tight text-slate-900 sm:text-4xl">
            {actorCanManageSubscription
              ...
              : t("Workspace Subscription Inactive", "Abonnement de l'espace de travail inactif", "Workspace-Abonnement inaktiv", "Suscripción del espacio de trabajo inactiva", "Subscrição do espaco de trabalho inativa")}
          </h1>
          <p className="mt-3 text-sm text-slate-600 sm:text-base">
            {actorCanManageSubscription
              ? hasPendingRenewalRedirect
                ? t("Your renewal is waiting on Flutterwave confirmation. Complete it to unlock full access.", "Votre renouvellement attend la confirmation Flutterwave. Finalisez-le pour debloquer l'accès complet.", "Deine Erneuerung wartet auf die Flutterwave-Bestätigung. Schliesse sie ab, um den vollen Zugriff freizuschalten.", "Tu renovacion esta pendiente de confirmacion de Flutterwave. Completala para desbloquear el acceso completo.", "A sua renovacao esta a aguardar confirmacao da Flutterwave. Conclua-a para desbloquear o acesso total.")
                : t("Your account is almost ready. Complete payment to unlock full access.", "Votre compte est presque pret. Finalisez le paiement pour debloquer l'accès complet.", "Dein Konto ist fast bereit. Schliesse die Zahlung ab, um den vollen Zugriff freizuschalten.", "Tu cuenta esta casi lista. Completa el pago para desbloquear el acceso completo.", "A sua conta esta quase pronta. Conclua o pagamento para desbloquear o acesso total.")
              : `${t("This workspace is currently unavailable because its subscription is inactive. Contact", "Cet espace de travail est actuellement indisponible car son abonnement est inactif. Contactez", "Dieser Workspace ist derzeit nicht verfügbar, weil sein Abonnement inaktiv ist. Kontaktiere", "Este espacio de trabajo no esta disponible porque su suscripción esta inactiva. Contacta con", "Este espaco de trabalho esta indisponivel porque a sua subscrição esta inativa. Contacte")} ${
            ...
            <p className="mt-1 text-sm text-slate-500">
              {actorCanManageSubscription
                ? hasPendingRenewalRedirect
                  ...
                  : t("Retry below to activate your subscription instantly.", "Reessayez ci-dessous pour activer instantanement votre abonnement.", "Versuche es unten erneut, um dein Abonnement sofort zu aktivieren.", "Vuelve a intentarlo abajo para activar tu suscripción al instante.", "Tente novamente abaixo para ativar a sua subscrição instantaneamente.")
                : owner?.email
