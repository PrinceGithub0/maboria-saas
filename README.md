...
- `app/` – pages & API routes
  - `api/` – auth (signup/reset/2fa), automation (run/schedule), workflows, payments (flutterwave/paystack + webhooks), invoices (pdf), ai/assistant, admin (overview/users/logs/support), business, usage, notifications, transactions, webhooks ingest
